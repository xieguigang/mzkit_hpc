...
CREATE TABLE IF NOT EXISTS `cluster_data` (
  ...
  `add_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `consensus` VARCHAR(4096) NULL DEFAULT NULL COMMENT 'consensus ions m/z value, network byte order data stream in base64 string',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `model_index` (`model_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `metadata` (
  ...
  INDEX `check_duplicated` (`hashcode` ASC, `filename` ASC, `cluster_id` ASC, `model_id` ASC, `project` ASC, `biodeep_id` ASC) VISIBLE,
